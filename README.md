...
<div>
<h2>&nbsp;Some of the tools I learned, used and loved ❤️</h2>
<p align="left">
...
<img src="https://cdn.jsdelivr.net/gh/devicons/devicon/icons/nodejs/nodejs-plain-wordmark.svg" alt="nodejs" width="45" height="45"/>
  ...
  <h2>&nbsp;My latest experience</h2>
	<p>I participated in the international internship program with CDG-Group in Bangkok (TH) where I had the opportunity to learn about Flutter, and do the first drafts of a full-stacck application. My previous experiences in other languages played a huge role in prototyping an app on a technology that i didn't know much beforehand. It was great and i learned a lot of valuable skills. I am still working on the prototype to aquire new skills in the field of mobile development.</p>
...
<ul>
	...
	<li>
		<h3 class="project-title">&nbsp;ft_server</h3>
		<p class="summary">
	...
	<li>
		<h3 class="project-title">&nbsp;webserv</h3>
		<p class="summary">
	...
	<li>
		...
		<h4> - cpp module 00 Basics, variables, I/O</h4>
		<h4> - cpp module 01 Memory allocation, reference, pointers</h4>
		<h4> - cpp module 02 Ad-hoc polymorphism, overloads and orthodox canonical classes</h4>
		<h4> - cpp module 03 Inheritance</h4>
		<h4> - cpp module 04 Subtype polymorphism, abstract classes and interfaces</h4>
		<h4> - cpp module 05 Try/Catch and Exceptions</h4>
		<h4> - cpp module 06 Casting</h4>
		<h4> - cpp module 07 Templates</h4>
		<h4> - cpp module 08 Templated containers, iterators and algorithms</h4>
	</li>
	<li>
		<h3 class="project-title">&nbsp;ft_containers</h3>
		<p class="summary">
	...
	<li>
		<h3 class="project-title">&nbsp;pipex</h3>
		<p class="summary">
	...
	<li>
		<h3 class="project-title">&nbsp;push_swap</h3>
		<p class="summary">
	...
	<li>
		<h3 class="project-title">&nbsp;cub3d</h3>
		<p class="summary">
	...
	<li>
		<h3 class="project-title">&nbsp;philosophers</h3>
		<p class="summary">
	...
	<li>
		<h3 class="project-title">&nbsp;fract-ol</h3>
		<p class="summary">
